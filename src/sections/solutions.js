...
const list = [
  'Posibilidad de diseño ilimitada',
  'Diseño compatible con todos los dispositivos',
];

const Solutions = () => {
  return (
    <Box as="section" id="solutions" sx={styles.section}>
      <Container>
        <Box sx={styles.grid}>
          <Box sx={styles.illustration}>
            <Image src={solutions} loading="lazy" alt="solutions" />
          </Box>
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              Te ayudamos a potenciar tu negocio con soluciones en software de calidad
            </Heading>
            <Text as="p" sx={styles.summary}>
              Estamos comprometidos a utilizar el conocimiento basado en hechos para todos nuestros clientes
            </Text>
