...
// import illustration from 'assets/images/banner-bg2.png';
import illustration from 'assets/images/bgblue2.jpg';
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            <Heading as="h1">
              Soluciones de software a medida para impulsar tu empresa
            </Heading>
            <Text as="p">
              Descubrí cómo podemos ayudarte a impulsar tu negocio con nuestras herramientas de desarrollo de software
            </Text>
            <SubscriptionForm sx={styles.subscriptionForm} />
            {/* <Flex sx={styles.sponsoredBy}>
              <Text as="span">Nuestros clientes</Text>
...
const styles = {
  ...
  contentWrapper: {
    ...
    alignItems: 'center',
    gridTemplateColumns: [null, null, null, null, '1fr 1fr', '630px 1fr'],
  ...
  bannerContent: {
    ...
    p: {
      ...
      lineHeight: [1.87, null, null, 2, null, 2],
      fontWeight: 800,
      color: '#D6D6D6',
      maxWidth: [null, null, 370, 470],
      m: ['10px auto 0', null, null, null, '15px auto 0'],
    },
  },
  subscriptionForm: {
