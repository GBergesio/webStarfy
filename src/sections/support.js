...
const data = [
  {
    id: 1,
    icon: wpp,
    title: 'Chat de soporte al cliente',
    text: `Estamos 100% comprometidos a resolver tus dudas e inconvenientes`,
  },
  {
    id: 2,
    icon: icon2,
          ...
          <div sx={styles.content}>
            <div sx={styles.heading}>
              ...
              <Text as="p" sx={styles.summary}>
                ...
                Una excelente atención al cliente es nuestra principal prioridad.
              </Text>
            </div>
            {/* <SectionHeading
              sx={styles.heading}
